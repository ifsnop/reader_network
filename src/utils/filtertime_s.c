...
Copyright (C) 2002-2024 Diego Torres <diego dot torres at gmail dot com>
...
int main(int argc, char *argv[]) {
    ...
    snprintf(start_date_str, 20, "1970-01-01 %s:00", argv[6]);
    snprintf(end_date_str, 20, "1970-01-01 %s:59", argv[7]);
