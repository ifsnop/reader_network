...
--lower-limit 0 \
--rigid \
DEF:media_1=$1_001.rrd:media_ds:AVERAGE LINE2:media_1#000099:"media cat1" \
DEF:media_2=$1_001.rrd:media_ds:AVERAGE LINE2:media_2#009900:"media cat1" \
DEF:min_1=$1_001.rrd:min_ds:AVERAGE LINE1:min_1#0000FF:"min cat1" \
DEF:max_1=$1_001.rrd:max_ds:AVERAGE LINE1:max_1#0000FF:"max cat1" \
...
DEF:media_2=$1_002.rrd:media_ds:AVERAGE LINE2:media_2#000099:"media cat1" \
DEF:min_2=$1_002.rrd:min_ds:AVERAGE LINE1:min_2#0000FF:"min cat1" \
DEF:max_2=$1_002.rrd:max_ds:AVERAGE LINE1:max_2#0000FF:"max cat1" 
